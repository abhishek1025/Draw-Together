...
import { Button, Input, Modal, QRCode, Tooltip } from "antd";
...
const ActiveUsersList = ({ ws, roomId }: { ws: WebSocket; roomId: string }) => {
  ...
  return (
    <>
        ...
        <div className="bg-white w-[140px] px-3 py-2 rounded relative flex items-center justify-between">
          ...
          >
            <div
              ...
              onClick={toggleDisplayUsersList}
            >
              <div>
          ...
          <div>
            <Button size="middle" type="primary" onClick={openInviteModal}>
              Invite
            </Button>
          </div>
        </div>
      ...
      {displayUsersList && (
        <div className="absolute bottom-5 right-4 bg-white rounded p-4 w-[325px] z-[2000]">
        ...
        footer={
          <div className="space-x-3">
            {generateQr ? (
              ...
              <>
                <Button type="default" onClick={closeInviteModal}>
                  Cancel
                </Button>

                <Button type="primary" onClick={copyInviteLink}>
                  Copy Invite
                </Button>
              </>
            )}
          ...
          {generateQr ? (
            ...
            <>
              ...
              <Input
                ...
                size="large"
                suffix={
                  <Copy className="cursor-pointer" onClick={copyInviteLink} />
                }
              />
            </>
          )}
