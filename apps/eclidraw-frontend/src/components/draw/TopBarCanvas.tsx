...
export default function TopBarCanvas(params: { selectedTool: ToolType, setSelectedTool: (s: ToolType) => void }) {
    ...
    return (<div className="fixed top-[5%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
        <div className="text-white flex gap-4 bg-gray-700 px-2 py-1 rounded">
            ...
            <IconButton icon={<MousePointer  height="15px"/>} onClick={() => {
                setSelectedTool('select')
            }} activated={selectedTool === 'select'}/>

            <IconButton icon={<Square  height="15px"/>} onClick={() => {
            ...
            <IconButton icon={<Circle height="15px"/>}  onClick={() => {
            ...
            <IconButton icon={<Minus height="15px"/>}  onClick={() => {
            ...
            <IconButton icon={<Eraser height="15px"/>}  onClick={() => {
